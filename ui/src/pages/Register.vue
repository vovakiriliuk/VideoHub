    ...
    <div class="auth-container">
      <form @submit.prevent="handleRegister" class="auth-form">
        <div class="form-header">
          <h1>Join <span class="text-green">VideoHub</span></h1>
          <p>Create an account to start sharing and discovering videos.</p>
        </div>
        ...
        <div class="form-body">
          <div class="form-group">
            ...
            <div class="input-icon-wrapper">
              ...
              <input v-model="username" type="text" required placeholder="yourusername" />
            </div>
          </div>
          <div class="form-group">
